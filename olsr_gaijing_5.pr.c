/* Process model C form file: olsr_gaijing_5.pr.c */
/* Portions of this file copyright 1986-2008 by OPNET Technologies, Inc. */



/* This variable carries the header into the object file */
const char olsr_gaijing_5_pr_c [] = "MIL_3_Tfile_Hdr_ 145A 30A op_runsim 7 5DB6A71D 5DB6A71D 1 USER-20151017SA Administrator 0 0 none none 0 0 none 0 0 0 0 0 0 0 0 1bcc 1                                                                                                                                                                                                                                                                                                                                                                                          ";
#include <string.h>
...
#define FIN_PREAMBLE_DEC	olsr_gaijing_5_state *op_sv_ptr;
#define FIN_PREAMBLE_CODE	\
		op_sv_ptr = ((olsr_gaijing_5_state *)(OP_SIM_CONTEXT_PTR->_op_mod_state_ptr));
...
extern "C" {
#endif
	void olsr_gaijing_5 (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Obtype _op_olsr_gaijing_5_init (int * init_block_ptr);
	void _op_olsr_gaijing_5_diag (OP_SIM_CONTEXT_ARG_OPT);
	void _op_olsr_gaijing_5_terminate (OP_SIM_CONTEXT_ARG_OPT);
	VosT_Address _op_olsr_gaijing_5_alloc (VosT_Obtype, int);
	void _op_olsr_gaijing_5_svar (void *, const char *, void **);
...
void
olsr_gaijing_5 (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	FIN_MT (olsr_gaijing_5 ());
		...
		FSM_ENTER ("olsr_gaijing_5")

		FSM_BLOCK_SWITCH
			{
			/*---------------------------------------------------------*/
			/** state (init) enter executives **/
			FSM_STATE_ENTER_FORCED_NOLABEL (0, "init", "olsr_gaijing_5 [init enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [init enter execs]", state0_enter_exec)
				{
				/***********设置一个自中断********************************/
			...
			FSM_STATE_EXIT_FORCED (0, "init", "olsr_gaijing_5 [init exit execs]")


			/** state (init) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "init", "st_1", "tr_0", "olsr_gaijing_5 [init -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (st_1) enter executives **/
			FSM_STATE_ENTER_UNFORCED (1, "st_1", state1_enter_exec, "olsr_gaijing_5 [st_1 enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [st_1 enter execs]", state1_enter_exec)
				{
			...
			FSM_EXIT (3,"olsr_gaijing_5")


			/** state (st_1) exit executives **/
			FSM_STATE_EXIT_UNFORCED (1, "st_1", "olsr_gaijing_5 [st_1 exit execs]")


			/** state (st_1) transition processing **/
			FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [st_1 trans conditions]", state1_trans_conds)
			...
			FSM_TRANSIT_SWITCH
				{
				FSM_CASE_TRANSIT (0, 2, state2_enter_exec, ;, "self_hello", "", "st_1", "hello_message_send", "tr_11", "olsr_gaijing_5 [st_1 -> hello_message_send : self_hello / ]")
				FSM_CASE_TRANSIT (1, 3, state3_enter_exec, ;, "self_tc", "", "st_1", "tc_message", "tr_15", "olsr_gaijing_5 [st_1 -> tc_message : self_tc / ]")
				FSM_CASE_TRANSIT (2, 4, state4_enter_exec, ;, "INTRPT_STRM_RECEIVOR", "", "st_1", "message_rcv", "rcv", "olsr_gaijing_5 [st_1 -> message_rcv : INTRPT_STRM_RECEIVOR / ]")
				FSM_CASE_TRANSIT (3, 5, state5_enter_exec, ;, "self_topu", "", "st_1", "topu_computer", "tr_20", "olsr_gaijing_5 [st_1 -> topu_computer : self_topu / ]")
				FSM_CASE_TRANSIT (4, 6, state6_enter_exec, ;, "INTRPT_STRM_DATA", "", "st_1", "data_send", "tr_22", "olsr_gaijing_5 [st_1 -> data_send : INTRPT_STRM_DATA / ]")
				FSM_CASE_TRANSIT (5, 7, state7_enter_exec, ;, "save_pk_send", "", "st_1", "save_send", "tr_24", "olsr_gaijing_5 [st_1 -> save_send : save_pk_send / ]")
				FSM_CASE_TRANSIT (6, 8, state8_enter_exec, ;, "SEND_FRAME", "", "st_1", "send", "tr_26", "olsr_gaijing_5 [st_1 -> send : SEND_FRAME / ]")
				FSM_CASE_TRANSIT (7, 1, state1_enter_exec, ;, "default", "", "st_1", "st_1", "tr_2", "olsr_gaijing_5 [st_1 -> st_1 : default / ]")
				}
				/*---------------------------------------------------------*/
			...
			FSM_STATE_ENTER_FORCED (2, "hello_message_send", state2_enter_exec, "olsr_gaijing_5 [hello_message_send enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [hello_message_send enter execs]", state2_enter_exec)
				{
				hello_send(HELLO,0);
				}
			...
			FSM_STATE_EXIT_FORCED (2, "hello_message_send", "olsr_gaijing_5 [hello_message_send exit execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [hello_message_send exit execs]", state2_exit_exec)
				{
				hello_send_flag=1;
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "hello_message_send", "st_1", "tr_14", "olsr_gaijing_5 [hello_message_send -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (tc_message) enter executives **/
			FSM_STATE_ENTER_FORCED (3, "tc_message", state3_enter_exec, "olsr_gaijing_5 [tc_message enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [tc_message enter execs]", state3_enter_exec)
				{
				tc_send();
				}
			...
			FSM_STATE_EXIT_FORCED (3, "tc_message", "olsr_gaijing_5 [tc_message exit execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [tc_message exit execs]", state3_exit_exec)
				{
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "tc_message", "st_1", "tr_17", "olsr_gaijing_5 [tc_message -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (message_rcv) enter executives **/
			FSM_STATE_ENTER_FORCED (4, "message_rcv", state4_enter_exec, "olsr_gaijing_5 [message_rcv enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [message_rcv enter execs]", state4_enter_exec)
				{
				recv();
				}
			...
			FSM_STATE_EXIT_FORCED (4, "message_rcv", "olsr_gaijing_5 [message_rcv exit execs]")


			/** state (message_rcv) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "message_rcv", "st_1", "tr_19", "olsr_gaijing_5 [message_rcv -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (topu_computer) enter executives **/
			FSM_STATE_ENTER_FORCED (5, "topu_computer", state5_enter_exec, "olsr_gaijing_5 [topu_computer enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [topu_computer enter execs]", state5_enter_exec)
				{
				compute_topu();
				}
			...
			FSM_STATE_EXIT_FORCED (5, "topu_computer", "olsr_gaijing_5 [topu_computer exit execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [topu_computer exit execs]", state5_exit_exec)
				{
			...
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "topu_computer", "st_1", "tr_21", "olsr_gaijing_5 [topu_computer -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (data_send) enter executives **/
			FSM_STATE_ENTER_FORCED (6, "data_send", state6_enter_exec, "olsr_gaijing_5 [data_send enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [data_send enter execs]", state6_enter_exec)
				{
				 p1=op_pk_get(TRANSPORT_TO_OLSR);
				 dest = 100;
				   op_pk_nfd_get(p1,"Destination Address", &dest);
			...
			FSM_STATE_EXIT_FORCED (6, "data_send", "olsr_gaijing_5 [data_send exit execs]")


			/** state (data_send) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "data_send", "st_1", "tr_23", "olsr_gaijing_5 [data_send -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (save_send) enter executives **/
			FSM_STATE_ENTER_FORCED (7, "save_send", state7_enter_exec, "olsr_gaijing_5 [save_send enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [save_send enter execs]", state7_enter_exec)
				{
				save_packet_send();
				save_send_flag=1;
				}
			...
			FSM_STATE_EXIT_FORCED (7, "save_send", "olsr_gaijing_5 [save_send exit execs]")


			/** state (save_send) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "save_send", "st_1", "tr_25", "olsr_gaijing_5 [save_send -> st_1 : default / ]")
				/*---------------------------------------------------------*/



			/** state (send) enter executives **/
			FSM_STATE_ENTER_FORCED (8, "send", state8_enter_exec, "olsr_gaijing_5 [send enter execs]")
				FSM_PROFILE_SECTION_IN ("olsr_gaijing_5 [send enter execs]", state8_enter_exec)
				{
				//priority_send();
				for(i=0;i<8;i++)
					{
			...
			FSM_STATE_EXIT_FORCED (8, "send", "olsr_gaijing_5 [send exit execs]")


			/** state (send) transition processing **/
			FSM_TRANSIT_FORCE (1, state1_enter_exec, ;, "default", "", "send", "st_1", "tr_27", "olsr_gaijing_5 [send -> st_1 : default / ]")
				/*---------------------------------------------------------*/
...
void
_op_olsr_gaijing_5_diag (OP_SIM_CONTEXT_ARG_OPT)
	{
	...
	FIN_MT (_op_olsr_gaijing_5_diag ())
...
void
_op_olsr_gaijing_5_terminate (OP_SIM_CONTEXT_ARG_OPT)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = __LINE__;
#endif

	FIN_MT (_op_olsr_gaijing_5_terminate ())
...
/* local variable prs_ptr in _op_olsr_gaijing_5_svar function. */
...
VosT_Obtype
_op_olsr_gaijing_5_init (int * init_block_ptr)
	{
	VosT_Obtype obtype = OPC_NIL;
	FIN_MT (_op_olsr_gaijing_5_init (init_block_ptr))

	obtype = Vos_Define_Object_Prstate ("proc state vars (olsr_gaijing_5)",
		sizeof (olsr_gaijing_5_state));
	*init_block_ptr = 0;
...
VosT_Address
_op_olsr_gaijing_5_alloc (VosT_Obtype obtype, int init_block)
	{
#if !defined (VOSD_NO_FIN)
	int _op_block_origin = 0;
#endif
	olsr_gaijing_5_state * ptr;
	FIN_MT (_op_olsr_gaijing_5_alloc (obtype))

	ptr = (olsr_gaijing_5_state *)Vos_Alloc_Object (obtype);
	if (ptr != OPC_NIL)
		{
		ptr->_op_current_block = init_block;
#if defined (OPD_ALLOW_ODB)
		ptr->_op_current_state = "olsr_gaijing_5 [init enter execs]";
#endif
		}
...
void
_op_olsr_gaijing_5_svar (void * gen_ptr, const char * var_name, void ** var_p_ptr)
	{
	olsr_gaijing_5_state		*prs_ptr;

	FIN_MT (_op_olsr_gaijing_5_svar (gen_ptr, var_name, var_p_ptr))
	...
	prs_ptr = (olsr_gaijing_5_state *)gen_ptr;
